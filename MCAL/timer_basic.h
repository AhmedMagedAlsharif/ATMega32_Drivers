...
extern "C" {
    ...
    typedef enum
    {
        Normal_Mode1 = 0x0000,                               //Top->0xFFFF
        PWM_PhaseCorrect_8Bit_Mode = 0x00A1,                 //Top->0x00FF
        PWM_PhaseCorrect_9Bit_Mode = 0x00A2,                 //Top->0x01FF
        PWM_PhaseCorrect_10Bit_Mode = 0x00A3,                //Top->0x03FF
        CTC_OCRA_Mode = 0x08A0,                              //Top->OCR1A
        Fast_PWM_8Bit_Mode = 0x08A1,                         //Top->0x00FF
        Fast_PWM_9Bit_Mode = 0x08A2,                         //Top->0x01FF
        Fast_PWM_10Bit_Mode = 0x08A3,                        //Top->0x03FF
        PWM_PhaseandFrequancyCorrect_ICR_Mode = 0x10A0,      //Top->ICR1
        PWM_PhaseandFrequancyCorrect_OCRA_Mode = 0x10A1,     //Top->OCR1A
        PWM_PhaseCorrect_ICR_Mode = 0x10A2,                  //Top->ICR1
        PWM_PhaseCorrect_OCRA_Mode = 0x10A3,                 //Top->OCR1A
        CTC_ICR_Mode = 0x18A0,                               //Top->ICR1
        _Reserved,
        Fast_PWM_ICR_Mode = 0xa8A2,                          //Top->ICR1
        Fast_PWM_OCRA_Mode = 0x18A3,                         //Top->OCR1A
